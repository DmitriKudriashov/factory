...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { category_id: @description.category_id, name: @description.name } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { category_id: @description.category_id, name: @description.name } }
